...
void ConvertLPairToLHE()
{
  ...
  const Int_t max_events = 40e3;

  TFile *f1 = TFile::Open("/afs/cern.ch/user/m/malvesga/work/ProtonRecon/archives/lpair/events.root");
  ...
  ofstream output("/afs/cern.ch/user/m/malvesga/work/ProtonRecon/archives/lpair/gammagammamumu.lpair.lhe");
