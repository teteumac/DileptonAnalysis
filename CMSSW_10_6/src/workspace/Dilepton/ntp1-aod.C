...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	TFile* f = new TFile("/eos/user/m/malvesga/GGToMuMu_Pt-50_Elastic_13TeV-lpair/Dimuon_Elastic_Fall2017/ProtonReconstruction_LPAIRmumuElastic_Fall2017_xangle150_cut.root", "RECREATE");
   //mumu_mass->DrawCopy();
   //mumu_pt->DrawCopy();
   //mumu_y->DrawCopy();
   //xi_left->DrawCopy();
