...
run("/eos/user/m/malvesga/miniaod/$file", false, 1)
.q
EOS
...
echo 'moving file'
cp output_cut.root /afs/cern.ch/user/m/malvesga/work/ProtonRecon/TEST/CMSSW_10_6_0/src/workspace/Dilepton_27_10_19/condor/histos_dy/$file
