...
void ntp1::Loop()
{
   ...
   TH1D *xi_pair_resolution_left = new TH1D("xi_pair_resolution_left", "Left #xi #mu^{+}#mu^{-} reco - #xi #mu^{+}#mu^{-} gen", 50, -.005, .005);
   ...
   TH1D *xi_pair_resolution_right = new TH1D("xi_pair_resolution_right", "Right #xi #mu^{+}#mu^{-} reco - #xi #mu^{+}#mu^{-} gen", 50, -.005, .005);
   ...
   //pixel efficiencies (radiation damage)
   TFile *eff_pixel = new TFile("/mnt/hadoop/cms/store/user/malvesga/efficiencies/pixelEfficiencies.root");
   ...
   //strips efficiencies (multitracking, radiation damage)
   TFile *eff_strips = new TFile("/mnt/hadoop/cms/store/user/malvesga/efficiencies/PreliminaryEfficiencies_October92019_1D2DMultiTrack.root");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //variables used on the efficiencies application
      double B_45_pixel;
      double C1_45_pixel;
      double E_45_pixel;
      double F1_45_pixel;
      ...
      //inefficiency on having just 1 proton 
      ...
      //efficiency on having just 1 proton 
      ...
      //xi equation for the reconstructed muon pair on the central system (CMS)
      ...
      //xi equation for the generated muon pair on the central system (CMS)
      ...
      if (cont_prot==0) multiplicity_0prot->Fill(contador_ext_PV3, eff_1prot_rp23*eff_1prot_rp123*Weight*sf_tight_muon);

      if(MuonCand_pt[0] > 50 && MuonCand_pt[1] > 50 && fabs(MuonCand_eta[0]) <= 2.4 && fabs(MuonCand_eta[1]) <= 2.4){ 
         umcortes = umcortes + Weight*sf_tight_muon;
         if (cont_prot==0) multiplicity_0prot_pt->Fill(contador_ext_PV3, eff_1prot_rp23*eff_1prot_rp123*Weight*sf_tight_muon);
         if(MuonCand_charge[0] * MuonCand_charge[1] < 0){
            doiscortes = doiscortes + Weight*sf_tight_muon;
            if(MuonCand_istight[0] && MuonCand_istight[1]){
               trescortes = trescortes + Weight*sf_tight_muon;
               if(v.M() > 110.){
                  quatrocortes = quatrocortes + Weight*sf_tight_muon;
                  h_PrimVertex_z->Fill(PrimVertexCand_z[0], Weight*sf_tight_muon);
                  if( fabs( PrimVertexCand_z[0] ) < 15.){
                     cincocortes = cincocortes + Weight*sf_tight_muon;
                     h_PrimVertex_dif_muon1->Fill(MuonCand_vtxz[0] - PrimVertexCand_z[0], Weight*sf_tight_muon);
                     h_PrimVertex_dif_muon2->Fill(MuonCand_vtxz[1] - PrimVertexCand_z[0], Weight*sf_tight_muon);
                     PrimVertex_ndof->Fill(PrimVertexCand_ndof[0], Weight*sf_tight_muon);
                     PrimVertex_chi2->Fill(PrimVertexCand_chi2[0], Weight*sf_tight_muon);
                     if( ( fabs(MuonCand_vtxz[0] - PrimVertexCand_z[0]) < 3*0.004 ) && ( fabs(MuonCand_vtxz[1] - PrimVertexCand_z[0]) < 3*0.004 ) ){
                        seiscortes = seiscortes + Weight*sf_tight_muon;
                        h_acoplanarity->Fill(a, Weight*sf_tight_muon);
                        h_deltaphi->Fill(deltaPhi(mu1.Phi(),mu2.Phi()), Weight*sf_tight_muon);
                        if(a < 0.009){
                           setecortes = setecortes + Weight*sf_tight_muon;
                           multiplicity_cut->Fill(contador_ext_PV3, Weight*sf_tight_muon);
                           if (cont_prot==0) multiplicity_0prot_cut->Fill(contador_ext_PV3, eff_1prot_rp23*eff_1prot_rp123*Weight*sf_tight_muon);
                           ...
                           if(contador_ext_PV3 <= 3){
                              oitocortes = oitocortes + Weight*sf_tight_muon;
                              mumu_mass->Fill(v.M(), Weight*sf_tight_muon);
                              mumu_pt->Fill(v.Pt(), Weight*sf_tight_muon);
                              mumu_y->Fill(v.Rapidity(), Weight*sf_tight_muon);
                              ...
                              for (unsigned int idx = 0; idx < nRecoProtCand; ++idx ) {
                                 cont_prot = cont_prot +  Weight*sf_tight_muon;
                                 bool fid_45 = false;
                                 bool fid_56 = false;
                                 ...
                                 if (ProtCand_trackpixshift1[idx] == 0) { 
                                    if(fid_45) {  
                                       if (ProtCand_rpid[idx] == 3) {
                                          if (ProtCand_ismultirp[idx] == 0) {
                                             ...
                                             double weight = weight_rddam*weight_multitrack*Weight*sf_tight_muon;
                                       ...
                                       if (ProtCand_rpid[idx] == 23) {
                                          if (ProtCand_ismultirp[idx] == 0) {
                                             ...
                                             double weight_rddam_C1 = C1_45_pixel = eff_pixel_rddam_C1_45->GetBinContent(eff_pixel_rddam_C1_45->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double weight_rddam_E = E_45_pixel = eff_pixel_rddam_E_45->GetBinContent(eff_pixel_rddam_E_45->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double weight_rddam_F1 = F1_45_pixel = eff_pixel_rddam_F1_45->GetBinContent(eff_pixel_rddam_F1_45->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double weight_rddam = ((weight_rddam_B*L_B + weight_rddam_C1*L_C1 + weight_rddam_E*L_E + weight_rddam_F1*L_F1)/(L_B+L_C1+L_E+L_F1))*Weight*sf_tight_muon;
                                             ...
                                             pair_xi_left_rp23_nprot->Fill(xi_pair_left_reco, weight_rddam);
                                             ...
                                             diff_proton_reco_pair_xi_left_rp23_nprot->Fill(ProtCand_xi[idx] - xi_pair_left_reco, weight_rddam); 
                                             ratio_proton_reco_pair_xi_left_rp23_nprot->Fill(1 - ProtCand_xi[idx]/xi_pair_left_reco, weight_rddam); 
                                             if (ProtCand_xi[idx] >= 0.02 && ProtCand_xi[idx] < 0.04) {
                                             ...
                                             if ( sigma_xi_RP23_nprot > 0.) {
                                                ...
                                                if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_left_reco ) <= n_sigmas_xi*sigma_xi_rp23_nprot_mumu ) {
                                                   match = true;
                                                   corte_match_rp23_nprot = corte_match_rp23_nprot + weight_rddam;
                                                   proton_xi_left_rp23_nprot_match->Fill(ProtCand_xi[idx], weight_rddam);
                                                   diff_proton_reco_pair_xi_left_rp23_nprot_match->Fill(ProtCand_xi[idx] - xi_pair_left_reco, weight_rddam); 
                                                   ratio_proton_reco_pair_xi_left_rp23_nprot_match->Fill(1 - ProtCand_xi[idx]/xi_pair_left_reco, weight_rddam); 
                                    ...
                                    if(fid_56) {  
                                       ...
                                       if (ProtCand_rpid[idx] == 123) {
                                          if (ProtCand_ismultirp[idx] == 0) {
                                             double weight_rddam_B = eff_pixel_rddam_B_56->GetBinContent(eff_pixel_rddam_B_56->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double weight_rddam_C1 = C1_56_pixel = eff_pixel_rddam_C1_56->GetBinContent(eff_pixel_rddam_C1_56->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double weight_rddam_E = E_56_pixel = eff_pixel_rddam_E_56->GetBinContent(eff_pixel_rddam_E_56->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double weight_rddam_F1 = F1_56_pixel = eff_pixel_rddam_F1_56->GetBinContent(eff_pixel_rddam_F1_56->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double weight_rddam = ((weight_rddam_B*L_B + weight_rddam_C1*L_C1 + weight_rddam_E*L_E + weight_rddam_F1*L_F1)/(L_B+L_C1+L_E+L_F1))*Weight*sf_tight_muon;
                                             ...
                                             pair_xi_right_rp123_nprot->Fill(xi_pair_right_reco, weight_rddam);
                                             ...
                                             diff_proton_reco_pair_xi_right_rp123_nprot->Fill(ProtCand_xi[idx] - xi_pair_right_reco, weight_rddam); 
                                             ratio_proton_reco_pair_xi_right_rp123_nprot->Fill(1 - ProtCand_xi[idx]/xi_pair_right_reco, weight_rddam); 
                                             if (ProtCand_xi[idx] >= 0.02 && ProtCand_xi[idx] < 0.04) {
                                             ...
                                             if ( sigma_xi_RP123_nprot > 0.) {
                                                ...
                                                if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_right_reco ) <= n_sigmas_xi*sigma_xi_rp123_nprot_mumu ) {
                                                   match = true;
                                                   corte_match_rp123_nprot = corte_match_rp123_nprot + weight_rddam;
                                                   proton_xi_right_rp123_nprot_match->Fill(ProtCand_xi[idx], weight_rddam);
                                                   diff_proton_reco_pair_xi_right_rp123_nprot_match->Fill(ProtCand_xi[idx] - xi_pair_right_reco, weight_rddam); 
                                                   ratio_proton_reco_pair_xi_right_rp123_nprot_match->Fill(1 - ProtCand_xi[idx]/xi_pair_right_reco, weight_rddam); 
                                    ...
                                    if(fid_45) {  
                                       if (ProtCand_arm[idx] == 0) {
                                          if (ProtCand_ismultirp[idx] == 1) {
                                             ...
                                             double pixel_weight_rddam_C1 = C1_45_pixel = eff_pixel_rddam_C1_45->GetBinContent(eff_pixel_rddam_C1_45->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double pixel_weight_rddam_E = E_45_pixel = eff_pixel_rddam_E_45->GetBinContent(eff_pixel_rddam_E_45->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double pixel_weight_rddam_F1 = F1_45_pixel = eff_pixel_rddam_F1_45->GetBinContent(eff_pixel_rddam_F1_45->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             ...
                                             double weight = pixel_weight_rddam*strips_weight_rddam*strips_weight_multitrack*Weight*sf_tight_muon;
                                    ...
                                    if (ProtCand_arm[idx] == 1) {                           
                                       if(fid_56) {  
                                          if (ProtCand_ismultirp[idx] == 1) {
                                             ...
                                             double pixel_weight_rddam_C1 = C1_56_pixel = eff_pixel_rddam_C1_56->GetBinContent(eff_pixel_rddam_C1_56->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double pixel_weight_rddam_E = E_56_pixel = eff_pixel_rddam_E_56->GetBinContent(eff_pixel_rddam_E_56->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double pixel_weight_rddam_F1 = F1_56_pixel = eff_pixel_rddam_F1_56->GetBinContent(eff_pixel_rddam_F1_56->FindBin(ProtCand_trackx1[idx], ProtCand_tracky1[idx]));
                                             double pixel_weight_rddam = (pixel_weight_rddam_B*L_B + pixel_weight_rddam_C1*L_C1 + pixel_weight_rddam_E*L_E + pixel_weight_rddam_F1*L_F1)/(L_B+L_C1+L_E+L_F1);
                              ...
                              if (cont_single_rp23==1 && fid_45_1prot){
                                 ...
                                 double weight_rddam = (weight_rddam_B*L_B + weight_rddam_C1*L_C1 + weight_rddam_E*L_E + weight_rddam_F1*L_F1)/(L_B+L_C1+L_E+L_F1);
                                 double weight = weight_rddam*eff_1prot_rp23*Weight*sf_tight_muon;
                                 ...
                                 proton_resolution_left_gen_rp23->Fill((xi_proton_gen_left - single_rp23_xi)/xi_proton_gen_left);
                                 proton_resolution_left_reco_rp23->Fill((single_rp23_xi - xi_proton_gen_left)/single_rp23_xi);
                              ...
                              if (cont_single_rp23==1 && fid_45_1prot){
                                 ...
                                 diff_proton_reco_pair_xi_left_single->Fill(single_left_xi - xi_pair_left_reco, weight); 
                                 ratio_proton_reco_pair_xi_left_single->Fill(1 - single_left_xi/xi_pair_left_reco, weight); 
                              ...
                              if (cont_single_rp123==1 && fid_56_1prot){
                                 ...
                                 double weight_rddam = (weight_rddam_B*L_B + weight_rddam_C1*L_C1 + weight_rddam_E*L_E + weight_rddam_F1*L_F1)/(L_B+L_C1+L_E+L_F1);
                                 double weight = weight_rddam*eff_1prot_rp123*Weight*sf_tight_muon;
                                 ...
                                 proton_resolution_right_gen_rp123->Fill((xi_proton_gen_right - single_rp123_xi)/xi_proton_gen_right);
                                 proton_resolution_right_reco_rp123->Fill((single_rp123_xi - xi_proton_gen_right)/single_rp123_xi);
      ...
      gr_pair_left->GetXaxis()->SetTitle("#xi(#mu^{+}#mu^{-})");
      gr_pair_left->GetYaxis()->SetTitle("#sigma(#xi(#mu^{+}#mu^{-}))");
      ...
      gr_pair_right->GetXaxis()->SetTitle("#xi(#mu^{+}#mu^{-})");
      gr_pair_right->GetYaxis()->SetTitle("#sigma(#xi(#mu^{+}#mu^{-}))");
      ...
      gr_rp23->SetTitle("#sigma x #xi - Proton Left");
      gr_rp23->GetXaxis()->SetTitle("#xi(RP)");
      gr_rp23->GetYaxis()->SetTitle("#sigma(#xi(RP))");
      ...
      gr_rp123->GetXaxis()->SetTitle("#xi(RP)");
      gr_rp123->GetYaxis()->SetTitle("#sigma(#xi(RP))");
      gr_rp123->Fit("pol1");
      ...
      gr_left_multi->GetXaxis()->SetTitle("#xi(RP)");
      gr_left_multi->GetYaxis()->SetTitle("#sigma(#xi(RP))");
      ...
      gr_right_multi->GetXaxis()->SetTitle("#xi(RP)");
      gr_right_multi->GetYaxis()->SetTitle("#sigma(#xi(RP))");
      ...
      proton_resolution_left_reco_rp23->GetXaxis()->SetTitle("#xi(RP)");
      proton_resolution_left_reco_rp23->GetYaxis()->SetTitle("Events");
      ...
      proton_resolution_right_reco_rp123->GetXaxis()->SetTitle("#xi(RP)");
      proton_resolution_right_reco_rp123->GetYaxis()->SetTitle("Events");
      ...
      xi_pair_resolution_left->SetXTitle("#xi(#mu^{+}#mu^{-})");
      xi_pair_resolution_left->GetYaxis()->SetTitle("Events");
      xi_pair_resolution_left->Write();
      gr_pair_left->Write();
      xi_pair_resolution_right->SetXTitle("#xi(#mu^{+}#mu^{-})");
      xi_pair_resolution_right->GetYaxis()->SetTitle("Events");
