...
#ifdef ntp1_cxx
ntp1::ntp1(std::string const& fileName_, std::string const& outfileName_, TTree *tree) : fChain(0), resample(false), resample_number(-1), fileName(fileName_), outfileName(outfileName_)
{
