...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2017B/DoubleMuon/MINIAOD/31Mar2018-v1/00000/4C58EEB0-6337-E811-8D28-D4AE527EEA1D.root')
)
...
process.patElectrons = cms.EDProducer("PATElectronProducer",
    ...
    userData = cms.PSet(
        ...
        userClasses = cms.PSet(
            src = cms.VInputTag(cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"))
        ),
        userFloats = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.patPhotons = cms.EDProducer("PATPhotonProducer",
    ...
    userData = cms.PSet(
        ...
        userClasses = cms.PSet(
            src = cms.VInputTag(cms.InputTag("egmPhotonIDs","mvaPhoID-Spring16-nonTrig-V1-wp80"), cms.InputTag("egmPhotonIDs","mvaPhoID-Spring16-nonTrig-V1-wp90"))
        ),
        userFloats = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.ggll_aod = cms.EDAnalyzer("GammaGammaLL",
    MCAcceptEtaCut = cms.untracked.double(-1.0),
    MCAcceptPtCut = cms.untracked.double(0.0),
    datapufile = cms.string('PUHistos_data.root'),
    datapupath = cms.string('pileup'),
    electronTag = cms.InputTag("patElectrons"),
    fetchProtons = cms.bool(True),
    fixedGridRhoFastjetAllLabel = cms.InputTag("fixedGridRhoFastjetAll"),
    genParticleTag = cms.InputTag("genParticles"),
    jetTag = cms.InputTag("patJets"),
    leptonsType = cms.string('Muon'),
    mcpufile = cms.string('PUHistos_mc.root'),
    mcpupath = cms.string('pileup'),
    metTag = cms.InputTag("patMETs"),
    muonTag = cms.InputTag("patMuons"),
    ...
    runOnMINIAOD = cms.bool(False),
    saveExtraTracks = cms.bool(False),
    sqrtS = cms.double(13000.0),
    trackTag = cms.InputTag("generalTracks"),
    triggerEvent = cms.InputTag("patTriggerEvent"),
    triggerResults = cms.InputTag("TriggerResults","","HLT"),
...
process.ggll_aod_pflow = cms.EDAnalyzer("GammaGammaLL",
    MCAcceptEtaCut = cms.untracked.double(-1.0),
    MCAcceptPtCut = cms.untracked.double(0.0),
    datapufile = cms.string('PUHistos_data.root'),
    datapupath = cms.string('pileup'),
...
process.ggll_miniaod = cms.EDAnalyzer("GammaGammaLL",
    MCAcceptEtaCut = cms.untracked.double(-1.0),
    MCAcceptPtCut = cms.untracked.double(0.0),
    datapufile = cms.string('PUHistos_data.root'),
    datapupath = cms.string('input_Event/N_TrueInteractions'),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('106X_dataRun2_v26'),
...
process.makePatOOTPhotonsTask = cms.Task(process.patOOTPhotons)
...
process.makePatLowPtElectronsTask = cms.Task(process.patLowPtElectrons)
...
process.patAlgosToolsTask = cms.Task(process.makePatJetsTask, process.makePatMETsTask, process.makePatTausTask, process.muonPFIsolationPATTask, process.patElectrons, process.patLowPtElectrons, process.patMuons, process.patOOTPhotons, process.patPhotons, process.pfElectronIsolationPATTask, process.pfParticleSelectionForIsoTask, process.pfPhotonIsolationPATTask, process.selectedPatCandidatesTask)
...
process.p = cms.Path(process.hltFilter+process.egmPhotonIDSequence+process.egmGsfElectronIDSequence+process.ggll_miniaod)
